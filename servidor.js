...
//console.log("Hola mundo desde NodeJS");//para esta prueba de una sola linea puede que no lleve ; al final de console.log("")
//IMPORTANDO PAQUETES Y GUARDANDO EN CONSTANTES:
...
mongoose.connect("mongodb+srv://prog_web:ProgWebMintic2022@clusterprogweb.irmh1.mongodb.net/ActividadesBD?retryWrites=true&w=majority");//cadena de conexión (se debe pone el password y el nombre de la base de datos)

//Operaciones CRUD: se muestran como ejemplo las operaciones de creación (CREATE) y lectura(READ). 
//CONSULTA PRÁCTICA individual: terminar de hacer las otras operaciones del CRUD pendientes (update/delete)
...
router.get('/tarea', (req, res) => {//es para pedir info desde el lado del cliente viniendo del servidor
...
router.post('/tarea', (req, res) => {//es para poner info desde el lado del cliente hacia el servidor
